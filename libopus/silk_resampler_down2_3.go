...
func silk_resampler_down2_3(S []int32, out []int16, in []int16, inLen int32) {
	...
	libc.MemCpy(unsafe.Pointer(buf), unsafe.Pointer(&S[0]), int(ORDER_FIR*unsafe.Sizeof(int32(0))))
	for {
		...
		silk_resampler_private_AR2([]int32(&S[ORDER_FIR]), []int32((*int32)(unsafe.Add(unsafe.Pointer(buf), unsafe.Sizeof(int32(0))*uintptr(ORDER_FIR)))), in, silk_Resampler_2_3_COEFS_LQ[:], nSamplesIn)
		buf_ptr = buf
		counter = nSamplesIn
		for int(counter) > 2 {
	...
	libc.MemCpy(unsafe.Pointer(&S[0]), unsafe.Pointer((*int32)(unsafe.Add(unsafe.Pointer(buf), unsafe.Sizeof(int32(0))*uintptr(nSamplesIn)))), int(ORDER_FIR*unsafe.Sizeof(int32(0))))
}
