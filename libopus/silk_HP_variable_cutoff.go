...
func silk_HP_variable_cutoff(state_Fxx []silk_encoder_state_FLP) {
	...
	if int(psEncC1.PrevSignalType) == TYPE_VOICED {
		...
		pitch_freq_log_Q7 = int32(int64(pitch_freq_log_Q7) + ((int64(int32((int64(int32(int(uint32(int32(-quality_Q15)))<<2))*int64(int16(quality_Q15)))>>16)) * int64(int16(int(pitch_freq_log_Q7)-(int(silk_lin2log(int32(float64(int(VARIABLE_HP_MIN_CUTOFF_HZ*(1<<16)))+0.5)))-(16<<7))))) >> 16))
